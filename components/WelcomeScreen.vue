      ...
      slides: [
        {
          ...
          title: 'Быстрый поиск',
          description: 'Найдите спортивную площадку и тренируйтесь рядом с домом, офисом или в поездке',
        },
        {
          img: '/images/welcome/1.png',
          title: 'Быстрый поиск 2',
          description: '2 Найдите спортивную площадку и тренируйтесь рядом с домом, офисом или в поездке',
        },
        {
          img: '/images/welcome/1.png',
          title: 'Быстрый поиск 3',
          description: '3 Найдите спортивную площадку и тренируйтесь рядом с домом, офисом или в поездке',
        },
      ]
    }
  },
